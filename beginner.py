#PROJECT STARTDATE : 9/10/2021
#PROJECT ENDDATE : 9/11/2021
...
async def on_message(message):
    ...
    #This will generate a list of things it can do when user says some command word. You can whatever you want for now i will choose 'hi'
    elif "hi" == message.content.lower():
